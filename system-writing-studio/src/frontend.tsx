...
.writing-studio{display:grid;grid-template-columns:minmax(0,1fr)minmax(0,var(--writing-studio-rail-width,22rem));width:100%;max-width:100%;height:100%;min-width:0;min-height:0;overflow:hidden;background:rgb(var(--color-base));color:rgb(var(--color-primary))}
.writing-studio.has-collapsed-rail{grid-template-columns:minmax(0,1fr)3rem}
.writing-studio-main{min-width:0;max-width:100%;overflow-y:auto;overflow-x:hidden;padding:2.25rem clamp(1.25rem,3vw,3rem) 4rem}
...
.writing-studio-chat-shell{min-width:0;min-height:0;max-width:100%;overflow:hidden;background:rgb(var(--color-base))}.writing-studio-extension-chat{display:flex;width:100%;max-width:100%;height:100%;min-width:0;min-height:0;overflow:hidden;flex-direction:column;background:rgb(var(--color-base));color:rgb(var(--color-primary));user-select:text}.writing-studio-extension-chat [aria-label="Extension chat composer"],.writing-studio-extension-chat [aria-label="Extension chat composer"]>*{min-width:0;max-width:100%;overflow-x:hidden}.writing-studio-extension-chat .ui-input-shell{width:100%;max-width:100%;min-width:0}.writing-studio-extension-chat select{min-width:0;max-width:100%}.writing-studio-extension-chat [class*="px-8"]{padding-left:.75rem;padding-right:.75rem}.writing-studio-extension-chat [class*="sm:px-10"]{padding-left:.75rem;padding-right:.75rem}.writing-studio-muted{margin:.9rem .75rem;color:rgb(var(--color-dim));font-size:.84rem;line-height:1.55}
...
@media(max-width:1320px){.writing-studio-canvas{grid-template-columns:minmax(0,1fr)}.writing-studio-comments{position:static;display:grid;gap:.65rem;min-height:0;padding-top:0}.writing-studio-comment{position:static!important;max-width:48rem}}
@media(max-width:1180px){.writing-studio,.writing-studio.has-collapsed-rail{grid-template-columns:1fr;grid-template-rows:minmax(0,1fr) minmax(18rem,42vh)}.writing-studio-rail{border-left:0;border-top:1px solid rgb(var(--color-border-subtle))}.writing-studio-rail-resizer{display:none}}
`;
